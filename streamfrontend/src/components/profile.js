...
import {  Dimmer, Loader,Button, Icon ,  Grid , Header ,  Modal  , Input} from 'semantic-ui-react';
...
class Profile extends Component
{
	constructor(props)
	{ super(props);
		this.state = { username:"" , first_name:"" , last_name:"" , userdetail:[] , active:true};
    		...
    		<div className="profileinfo" >
				  ...
				  <Grid columns={3} >
				    <Grid.Row>
				      ...
				      <Grid.Column>
				        <Header as='h3'> {(this.state.username!=='')?this.state.username:null}</Header>
				      </Grid.Column>
				      <Grid.Column>
				    ...
				    <Grid.Row>
				      ...
				      <Grid.Column>
				        <Header as='h3'> {this.state.first_name}</Header>
				      </Grid.Column>
				      <Grid.Column>
				      ...
				      <Grid.Column>
				        <Header as='h3'> {this.state.last_name}</Header>
				      </Grid.Column>
				      <Grid.Column>
